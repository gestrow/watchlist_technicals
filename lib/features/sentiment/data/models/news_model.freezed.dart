...
mixin _$NewsModel {
  ...
  double get sentimentScore =>
      throw _privateConstructorUsedError; // -1 to +1 from MarketAux
...
// -1 to +1 from MarketAux
  ...
  @override
  String toString() {
    return 'NewsModel(headline: $headline, description: $description, url: $url, publishedAt: $publishedAt, sentimentScore: $sentimentScore, source: $source, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, headline, description, url,
      publishedAt, sentimentScore, source, imageUrl);
...
abstract class _NewsModel implements NewsModel {
  const factory _NewsModel(
      ...
      final String? imageUrl}) = _$NewsModelImpl;
  ...
  @override
  double get sentimentScore;
  @override // -1 to +1 from MarketAux
  String get source;
  @override
  String? get imageUrl;
  @override
